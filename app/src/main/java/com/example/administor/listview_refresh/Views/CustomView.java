package com.example.administor.listview_refresh.Views;
        ...
        import com.example.administor.listview_refresh.R;

public class CustomView extends ListView implements OnScrollListener {
...
//        setCacheColorHint(android.R.color.black);
        ...
        mHeadView = (LinearLayout) mInflater.inflate(R.layout.header_view, null);
